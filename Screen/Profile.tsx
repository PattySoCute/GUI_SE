...
import { Bell, PencilSimple, Toilet, CaretRight, ClockCounterClockwise, GearSix } from 'phosphor-react-native'
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.btnRectangle_2}>
        <View style={styles.itemLeft}>
          ...
          <TouchableOpacity style={styles.bgIconSetting}>
            <GearSix size={22} weight="fill" color='#2C2F4A' />
          </TouchableOpacity>
